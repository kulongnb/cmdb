# Generated by Django 2.1.5 on 2019-11-06 16:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('authed', models.BooleanField(default=False, help_text='是否建立互信', verbose_name='是否认证')),
            ],
            options={
                'verbose_name': '服务器连接表',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manager_id', models.GenericIPAddressField(default='', null=True, verbose_name='IP地址')),
                ...
                ('latest_date', models.DateField(blank=True, default=django.utils.timezone.now, null=True, verbose_name='更新时间')),
                ('create_at', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('asset', models.OneToOneField(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='server', to='cmdb.Asset', verbose_name='资产')),
        ...
        migrations.AddField(
            ...
            name='server',
            field=models.ManyToManyField(related_name='Inventorypool', to='cmdb.Server'),
        ),
        migrations.AddField(
            model_name='disk',
            name='server',
